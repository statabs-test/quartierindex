...
const SelectionNavigation: React.SFC<SelectionNavigationProps> = ({ valid }) => {
  return (
    <Grid container justify="space-between">
      <Grid item xs={2}>
        <NavButton disabled={!valid} variant="raised" to={'/plot'}>
          Rangliste
        </NavButton>
      </Grid>
      <Grid className={valid ? 'showDescription' : 'hideDescription'} item xs={8}>
        ...
        <p className="stepper-description">
          ...
          und die Gewichtung in separaten Arbeitsschritten für jeden ausgewählten Indikator einzeln
          anpassen.
        </p>
      </Grid>

      <Grid item xs={2}>
        <NavButton disabled={!valid} variant="raised" to={'/ranking'}>
